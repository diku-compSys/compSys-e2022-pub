...
|      | 05 Oct | OS    | Troels   | Virtual memory - OS perspective                                               | ???                                                                                                                                                       |
|      |        |       |          | Hand-in A1 -- dynamic allocation + caching                                    |          |
| 41   | 10 Oct | OS    | Troels   | Concurrency I                                                                 | 6.1-6.5 and ??? on the pthreads API                                                                                              |
|      | 12 Oct | OS    | Troels   | Concurrency II                                                                | ??? and [this text on condition variables](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-cv.pdf)                                                         |
